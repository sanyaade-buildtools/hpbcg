...
\item[Power4]  
  \begin{itemize}
    ...
    \item Altivec extension : To be done
  \end{itemize}
\end{description}
...
\url{http://www.ibm.com/developerworks/java/jdk/linux/} could be useful
...
Pleas not that the value 42 is choos by the user and can not be
