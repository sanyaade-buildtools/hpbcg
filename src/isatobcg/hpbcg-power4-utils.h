...
#define bt_iII(C,D)			bc_iIII(12, C, D)
#define bf_iII(C,D)			bc_iIII( 4, C, D)
#define bdnzt_iII(C,D)			bc_iIII( 8, C, D)
#define bdnzf_iII(C,D)			bc_iIII( 0, C, D)
#define bdnz_iI(D)			bc_iII(16, 0, D)
#define bdzt_iII(C,D)			bc_iIII(10, C, D)
#define bdz_iI(D)			bc_iIII(18, 0, D)
#define bdzf_iII(C,D)			bc_iIII( 2, C, D)
...
#define blt_iII(C,D)			bc_iIII(12, ((C)<<2)+0, D)
#define ble_iII(C,D)			bc_iIII( 4, ((C)<<2)+1, D)
#define beq_iII(C,D)			bc_iIII(12, ((C)<<2)+2, D)
#define bge_iII(C,D)			bc_iIII( 4, ((C)<<2)+0, D)
#define bgt_iII(C,D)			bc_iIII(12, ((C)<<2)+1, D)
#define bnl_iII(C,D)			bc_iIII( 4, ((C)<<2)+0, D)
#define bne_iII(C,D)			bc_iIII( 4, ((C)<<2)+2, D)
#define bng_iII(C,D)			bc_iIII( 4, ((C)<<2)+1, D)
#define bso_iII(C,D)			bc_iIII(12, ((C)<<2)+3, D)
#define bns_iII(C,D)			bc_iIII( 4, ((C)<<2)+3, D)
#define bun_iII(C,D)			bc_iIII(12, ((C)<<2)+3, D)
#define bnu_iII(C,D)			bc_iIII( 4, ((C)<<2)+3, D)
...
#define mtlr_iR(RS)			mtspr_iIR(8, RS)	
#define mflr_iR(RD)			mfspr_iRI(RD, 8)
#define mtctr_iR(RS)			mtspr_iIR(9, RS)
#define mfctr_iR(RD)			mfspr_iRI(RD, 9)
#define mtxer_iR(RS)			mtspr_iIR(1, RS)
